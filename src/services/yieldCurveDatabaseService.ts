...
const DATABASE_CURVES: Record<string, YieldCurveConfig> = {
  ...
  USD: {
    ...
    instruments: [
      ...
      { ticker: 'USSO15M Curncy', tenor: 456, label: '15M', type: 'ois' },
      { ticker: 'USSO18M Curncy', tenor: 548, label: '18M', type: 'ois' },
      { ticker: 'USSO21M Curncy', tenor: 639, label: '21M', type: 'ois' },
      { ticker: 'USSO2 Curncy', tenor: 730, label: '2Y', type: 'ois' },
      ...
      { ticker: 'USSO10 Curncy', tenor: 3650, label: '10Y', type: 'ois' },
      { ticker: 'USSO15 Curncy', tenor: 5475, label: '15Y', type: 'ois' },
      { ticker: 'USSO20 Curncy', tenor: 7300, label: '20Y', type: 'ois' },
      { ticker: 'USSO25 Curncy', tenor: 9125, label: '25Y', type: 'ois' },
